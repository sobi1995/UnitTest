...
{
    public class CalculatorTest: IClassFixture<GenericFixtrue<Calculator>>
    {
 private readonly GenericFixtrue<Calculator> _fixture;
        public CalculatorTest( GenericFixtrue<Calculator> fixture)
        {
            _fixture=fixture;
        }
        [Fact]
